...
@section('content')
    <div class="wrap">
		...
		<a>投稿ガイドライン</a><br>
		<br>
        <h2 style="text-align: center;">レビュー投稿ガイドライン</h2><br>
        <br>
        ...
        <h4>ユーザー登録について</h4>
        <br>
        <a>■レビューを投稿するには、事前のユーザー登録及びログインが必要です。トップメニューの中にある「ユーザー登録」リンクからユーザー登録をしてください。</a><br>
        <br>
        <a>■登録時の内容は後でマイページから編集が可能ですが、パスワードは変更できません。</a><br>
        <br>
        <a>■パスワードの文字数は8文字以上です。</a><br>
        <br>
        <a>■登録完了後、サイト上部のメールアドレス・パスワード欄にそれぞれ入力して、ログインしてください。以降、書き込みができるようになります。</a><br>
        <br>
        <a>----------------------------------------------------------------------</a><br>
        <br>
        <h4>その他注意事項</h4>
        <br>
        <a>■画像のアップロードも可能です。画像は必須ではありませんが、画像があると読んでいて楽しいと思います。ご自分で実際に使用されている写真などがあればきっとさらに魅力的なレビューになることでしょう。<a><br>
        <br>
        <a>■すでに誰かがレビューを書いている製品について自分もレビューを書きたいという場合は、該当製品のレビューページにある”同製品のレビューを追加”ボタンからの投稿を推奨します。</a><br>
        <br>
